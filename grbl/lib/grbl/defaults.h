...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_STEPS_PER_MM 466.667
  #define DEFAULT_Y_STEPS_PER_MM 250.0
  #define DEFAULT_Z_STEPS_PER_MM 250.0
  #define DEFAULT_X_MAX_RATE 60 // mm/min
  #define DEFAULT_Y_MAX_RATE 1 // mm/min
  #define DEFAULT_Z_MAX_RATE 1 // mm/min
  #define DEFAULT_X_ACCELERATION (3*60*60) // 3*60*60 mm/min^2 = 3 mm/sec^2
  ...
  #define DEFAULT_HOMING_FEED_RATE 5 // mm/min
  #define DEFAULT_HOMING_SEEK_RATE 25 // mm/min
